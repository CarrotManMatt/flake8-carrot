...
`+CAR160+` - `+content-in-abstract-method+`:: The body of abstract methods should only contain a docstring (or `+pass+` if the function is an overload or is private and has no docstring)
