...
class RuleCAR306(CarrotRule, ast.NodeVisitor):
    ...
    class _ContextCommandType(Enum):
        ...
        @classmethod
        def get_from_decorator_node(cls, decorator_node: ast.Call) -> "RuleCAR306._ContextCommandType":
    ...
    def format_error_message(cls, ctx: Mapping[str, object]) -> str:
        context_command_type: object | None = ctx.get("context_command_type")
    ...
    def _check_single_argument(self, argument: ast.expr, context_command_type: "RuleCAR306._ContextCommandType") -> None:  # noqa: C901, PLR0911, PLR0912
    ...
    def _check_all_arguments(self, decorator_node: ast.Call) -> None:  # noqa: E501
        ...
        if decorator_node.args:
            ...
            self._check_single_argument(positional_argument, context_command_type)
